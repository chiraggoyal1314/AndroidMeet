...
//    getSupportActionBar().hide();
    ...
    Button btn = (Button) findViewById(R.id.up_button);
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
          ...
          public boolean onMenuItemClick(MenuItem item) {
            ...
            switch(item.getItemId()) {
              case R.id.participants_button:
                intent = new Intent(RoomActivity.this, Participants.class);
                startActivity(intent);
                break;
              case R.id.rasie_hand_button:

                break;
              case R.id.chat_button:
                intent = new Intent(RoomActivity.this, ChatRoom.class);
                startActivity(intent);
                break;
              default:
                Toast.makeText(RoomActivity.this, "Some Text" + item.getTitle(), Toast.LENGTH_SHORT).show();
            }
            return true;
          }
        });
  ...
  private void showBottomSheetDialog() {
    ...
    bottomSheetDialog.setContentView(R.layout.bottom_navigation_sheet);
...
//    }
    ...
    // Notify
    @SuppressLint("WrongConstant") final Observer<Notify> notifyObserver =
        notify -> {
          if (notify == null) {
            return;
          }
          if ("error".equals(notify.getType())) {
            @SuppressLint("WrongConstant") Toast toast = Toast.makeText(this, notify.getText(), notify.getTimeout());
